...
type LiveProps = Pick<BouncingBallProps, "ballColor" | "ballSize" | "backgroundColor" | "horizontalDrift">;
...
export const BouncingBallComposition: React.FC<BouncingBallProps> = (schemaProps) => {
  const [liveProps, setLiveProps] = useState<LiveProps>({
    ...
    backgroundColor: schemaProps.backgroundColor,
    horizontalDrift: schemaProps.horizontalDrift,
  });
    ...
    const applyProps = async () => {
      try {
        ...
        setLiveProps({
          ...
          backgroundColor: data.backgroundColor ?? schemaProps.backgroundColor,
          horizontalDrift: data.horizontalDrift ?? schemaProps.horizontalDrift,
        });
      } catch (err) {
